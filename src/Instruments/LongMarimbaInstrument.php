...
class MarimbaInstrument implements Instrument
{
	...
	{
		if ($duration < 1) {
			return $this->short($frequency, $t, $value);
		}

		return $this->long($frequency, $t, $value);
	}

	private function short($frequency, $t, &$value): bool
	{
		$duration = 1;
	...
	private function long($frequency, $t, &$value): bool
	{
		$duration = 1;
